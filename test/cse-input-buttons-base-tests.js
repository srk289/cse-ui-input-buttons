...
function runBaseTests() {
  cse_input_buttons_1 = document.getElementById('cse_input_buttons_1');

  suite('Base Automation Tests for cse-input-buttons', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('cse-input-buttons fixture is created', function() {
      assert.isTrue(document.getElementById('cse_input_buttons_1') !== null);
    });
